...
*Last Updated: 2026-02-17 (v0.9.0 Wiki Implementation)*
...
## 9. The Wiki (v0.9.0) & Digital Aristotle (v0.9.1)

### v0.9.0: Personal Wiki
The wiki represents **knowledge sovereignty**: local document processing, vector search, citation system with trust levels (personal/curated/web).

**Architecture:**
- **Ingestion**: Drop PDFs, Markdown, TXT into `data/sources/`
- **Processing**: Extract text, split into 500-1000 token chunks with overlap
- **Embeddings**: Ollama `nomic-embed-text` for semantic vectors
- **Storage**: ChromaDB for vectors, SQLite for metadata
- **Retrieval**: Semantic search weighted by trust level
- **Citations**: Every answer includes source, page/section, direct quote
...
### v0.9.1: Digital Aristotle (Future)
**The Digital Aristotle** transforms Noctem from assistant to intellectual companion through:
- Query mode (grounded answers with citations)
- Socratic mode (questions and challenges)
- Review mode (spaced repetition)

See improvements.md for full schema and implementation details.
...
**Phase 1: Foundation (v0.6-0.7)** ✔️ - Execution logging, correction feedback, self-improvement engine  
**Phase 2: Skills (v0.8)** ✔️ - Skill registry, progressive disclosure, user-created skills  
**Phase 3a: Knowledge (v0.9.0)** 🚧 - Document ingestion, vector search, citation system  
**Phase 3b: Learning (v0.9.1)** - Digital Aristotle, Socratic mode, spaced repetition  
