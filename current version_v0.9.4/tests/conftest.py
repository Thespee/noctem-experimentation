...
# v0.9.3 Phase 2: legacy runtime suites removed from active backend.
# Keep these tests out of default collection for the v0.9.3 workspace.
collect_ignore_glob = [
    "test_skill_*.py",
    "test_v060_*.py",
    "test_v061_*.py",
    "test_v070_*.py",
    "test_noctem.py",
    "test_v091_command_shortcuts.py",
    "test_v091_feedback_sessions.py",
    "test_v091_skill_wiki.py",
    "test_v091_web_views.py",
    "test_v091_wiki_cli.py",
    "test_v093_local_operational_readiness.py",
    "test_imports.py",
]
