...
class TestWhisperService:
    ...
    def test_whisper_service_config(self):
        ...
        from noctem.voice.transcription import WhisperService, DEFAULT_MODEL, DEFAULT_DEVICE
    ...
    def test_whisper_singleton(self):
        ...
        from noctem.voice.transcription import get_whisper_service
...
class TestVoiceJournalImports:
    ...
    def test_import_whisper_module(self):
        ...
        from noctem.voice import transcription as whisper
...
class TestVoiceProcessingPipeline:
    """Tests for retained voice transcription processing in v0.9.3."""
    
    def test_processing_module_has_entrypoint(self):
        """Test voice processing module exposes queue processor."""
        from noctem.voice import processing
        assert hasattr(processing, "process_pending_voice_journals")
    
    def test_scheduler_has_voice_job(self):
        """Scheduler module should expose idle coordinator + scheduler entrypoints."""
        from noctem.scheduler import jobs
        assert hasattr(jobs, "create_scheduler")
        assert hasattr(jobs, "record_user_activity")
        assert hasattr(jobs, "get_scheduler_status")
