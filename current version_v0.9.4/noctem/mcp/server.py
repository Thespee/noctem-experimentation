...
from .tools import pop_request_context, push_request_context, register_read_only_tools
...
class NoctemMCPServer:
    ...
    def call_tool(
        ...
        *,
        ...
        try:
            context_token = push_request_context(normalized)
            try:
                result = tool.handler(payload, normalized)
            finally:
                pop_request_context(context_token)
